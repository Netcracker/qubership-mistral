...
![Overview](/docs/images/grafana_overview.PNG)
...
![Mistral Apps Status](/docs/images/mistral_apps_status.PNG)
...
![Total Mistral Entities](/docs/images/grafana_total_mistral_entities.PNG)
...
![Mistral CPU Usage](/docs/images/grafana_mistral_cpu_usage.PNG)
...
![Mistral MEM Usage](/docs/images/grafana_mistral_mem_usage.PNG)
...
![RabbitMQ](/docs/images/grafana_rabbitmq.PNG)
