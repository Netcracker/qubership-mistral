...
RUN pip install --no-cache-dir --no-index --find-links=/wheels -r nc_requirements.txt
RUN pip install --no-dependencies --no-cache-dir --no-build-isolation -e $MISTRAL_HOME && \
